<template>
    <div>
        ...
        <el-table @sort-change="sort" :default-sort = "{prop: 'date', order: 'descending'}" class="table" border ref="multipleTable" :data="tableDate" highlight-current-row v-loading="listLoading"  style="width: 100%;">
			...
			<el-table-column prop="time" label="回收时间" align="center"  >
			</el-table-column>
			<el-table-column prop="dealers" label="回收经销商"  align="center" >
			</el-table-column>
            <el-table-column prop="number" label="回收数量"  sortable align="center">
			</el-table-column>
            <el-table-column prop="state" label="回收状态"  align="center">
			</el-table-column>
